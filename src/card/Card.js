...
const Card = (props) => {
  ...
  return(
    <div className="cards flex-row pt-3  d-flex ">
      <div className={` ${props.success===0?"col-4":props.success===1?"col-6 px-4":"col-12 px-5"} card py-3 ${props.alreadyAnswer.includes(0)?"d-none":""}`}>
      ...
      <div className={` ${props.success===0?"col-4":props.success===1?"col-6 px-4":"col-12 px-5"} card py-3 ${props.alreadyAnswer.includes(1)?"d-none":""}`}>
      ...
      <div className={`${props.success===0?"col-4":props.success===1?"col-6 px-4":"col-12 px-5"} card py-3 ${props.alreadyAnswer.includes(2)?"d-none":""}`}>
        <div className={`card-content px-3 d-flex align-items-center mx-auto ${props.curtainUp?"cardDisplay":""}`} style={{ backgroundImage:`url(${cardBackground})` ,backgroundSize:"cover"}}>
